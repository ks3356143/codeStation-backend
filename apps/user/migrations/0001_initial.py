    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', shortuuidfield.fields.ShortUUIDField(blank=True, editable=False, help_text='用户唯一ID', max_length=22, primary_key=True, serialize=False, verbose_name='用户唯一ID')),
